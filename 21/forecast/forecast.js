...
// http://api.openweathermap.org/data/2.5/forecast/daily?q=Skopje&units=metric&cnt=3&APPID=c10bb3bd22f90d636baa008b1529ee25


const getData = async(city, days) => fetch(`http://api.openweathermap.org/data/2.5/forecast/daily?q=${city}&units=metric&cnt=${days}&APPID=c10bb3bd22f90d636baa008b1529ee25`)
...
const catchError = (err) => {
    const forecastNode = document.getElementById('forecastWeather')
    forecastNode.innerHTML = ''
    // realno, errors se pustaat na modal, toast message
...
const getForecast = () => {
    ...
    // da gi povlecme podatocite od nekoj API server
